...
class VouchersController extends Controller
{
    ...
    public function index(){
      ...
      return view('pages.vouchers-all',['pageConfigs'=>$pageConfigs,'breadcrumbs'=>$breadcrumbs]);
    }
    ...
    public function archive(){
      ...
      $breadcrumbs = [
        ["link" => "/", "name" => "Home"],["link" => "/vouchers", "name" => "Vouchers"],["name" => "Vouchers Archive"]
      ];

      return view('pages.vouchers-archive',['pageConfigs'=>$pageConfigs,'breadcrumbs'=>$breadcrumbs]);
    }
