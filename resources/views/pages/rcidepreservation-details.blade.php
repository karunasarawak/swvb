                                        ...
                                        <div class="card-body card-dashboard">
                                            <!-- <div class="table-responsive">
                                                <table class="table table-borderless" >
                                                    <thead>
                                                        <tr>
                                                        <th class="h7 swvb-blue m-0 font-weight-bold my-auto pb-2" >Basic<i class="bx bx-pencil"></i></th>
                                                        <th></th>
                                                        <th class="h7 swvb-blue m-0 font-weight-bold my-auto pb-2" >Package<i class="bx bx-pencil"></i></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td>RCI Deposit</td>
                                                            <td>Yes</td>
                                                            <td>RCI Membership No.</td>
                                                            <td>6</td>
                                                        </tr>
                                                        <tr>
                                                            <td>II Deposit</td>
                                                            <td>1234 1234</td>
                                                            <td>II Membership No.</td>
                                                            <td>6</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>II Exchange</td>
                                                            <td>01 April 2020</td>
                                                            <td>Email Date From RCI</td>
                                                            <td><input type="date" name="npdate" class="form-control" value="01 June 2020" data-validation-required-message="Please write the email date from RCI" required></td>
                                                        </tr>
                                                        <tr>
                                                            <td>II Deposit Ref No</td>
                                                            <td>124142141</td>
                                        ...
                                        <div class="card-content">
                                            <!-- <div class="table-responsive">
                                                <table class="table table-borderless" style="width:1500px;">
                                                    <thead>
                                                        <tr>
                                                        <th class="h7 swvb-blue m-0 font-weight-bold my-auto pb-2">Voucher<i class="bx bx-pencil"></i></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>Nights</td>
                                                            <td>Mid Year Promo</td>
                                                            <td>Discount</td>
                                                            <td>RM100</td>
                                                        </tr>
                                                        <thead>
                                                            <tr>
                                                                <th class="h7 swvb-blue m-0 font-weight-bold my-auto pb-2">Promo <i class="bx bx-pencil"></i></th>
                                                            </tr>
                                                        </thead>
                                                        <tr>
                                                            <td>Promo Name</td>
                                                        ...
                                                        <tr>
                                                            <td>Promo Period</td>
                                                            <td>1 July 2020 - 31 July 2020</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div> -->
