            ...
            <div class="card">
                ...
                <div class="card-content">
                        <div class="row pt-1 pl-2" >
                            <div class="col">
                                <p class="h7 swvb-blue ml-2 font-weight-bold my-auto pb-2">Suppliers</p>
                            </div>
                        </div>
                    <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            ...
                            <table class="table tours-all">
                                <thead class="bg-swvb-dark">
                                    <tr>
                                        <th class="text-white" style="width:30%">Suppliers<button class="btn btn-outline-white round mr-1 ml-1 text-white" data-toggle="modal" data-target="#addroles"><i class="bx bx-plus white"></i></button></th>
                                        <th class="text-white">Company</th>
                                        <th class="text-white">Mobile</th>
                                        <th class="text-white expanded" style="width:10%">Whatsapp</th>
                        ...
                        <div class="row pt-1 pl-2" >
                            <div class="col">
                                <p class="h7 swvb-blue ml-2 font-weight-bold my-auto pb-2">Telemarketers</p>
                            </div>
                        </div>
                    <div class="card-body card-dashboard">
                        <div class="table-responsive">
                    ...
                    <div class="row pt-1 pl-2" >
                            <div class="col">
                                <p class="h7 swvb-blue ml-2 font-weight-bold my-auto pb-2">Sales Venue</p>
                            </div>
                        </div>
                    <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            ...
                            <table class="table tours-all">
                                <thead class="bg-swvb-dark">
                                    <tr>
                                        <th class="text-white" style="width:50%">ID<button class="btn btn-outline-white round mr-1 ml-1 text-white" data-toggle="modal" data-target="#addroles"><i class="bx bx-plus white"></i></button></th>
                                        <th class="text-white" style="width:50%">Sales Venue</th>
