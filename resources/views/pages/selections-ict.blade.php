        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-swvb-cyan">
                    <div class="row">
                        <h4 class="card-title text-white ml-2">ICT Request Type<button class="btn btn-outline-white round mr-1 ml-1" data-toggle="modal" data-target="#addict">New</button></h4>
                    </div>    
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table tours-all">
                                <thead class="bg-swvb-dark">
                                    <tr>
                                        <th class="text-white" style="width:30%">ICT Request Type</th>
                                        <th class="text-white" style="width:30%">Remarks</th>
...
<!--update status Modal for status: Suspend-->
<div class="modal fade text-left" id="newdcitem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-swvb-blue">
...
<!--update status Modal for status: Suspend-->
<div class="modal fade text-left" id="addict" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-swvb-blue">
                <h4 class="modal-title text-white" id="myModalLabel33">New ICT Request Type</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i class="bx bx-x"></i>
                </button>
            </div>
            <form action="#">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="controls">
                            <label > Type of ICT Request</label>
                            <input  type="text" name="company_name" class="form-control" placeholder="" data-validation-required-message="Please write the company name"  required>
                        </div>
                    </div>
