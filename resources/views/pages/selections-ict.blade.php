        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-swvb-cyan">
                    <div class="row">
                        <h4 class="card-title text-white ml-2">ICT Request Type</h4>
                    </div>    
                </div>
                <div class="card-content">
                    ...
                    <div class="card-body card-dashboard">
                        <div class="row pt-1 pl-2" >
                            <div class="col">
                                <button class="btn btn-primary round mr-1 ml-1 mb-2 text-white" data-toggle="modal" data-target="#addchargetype">New</button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table tours-all" style="width:100%;">
                                <thead class="bg-swvb-dark">
                                    <tr>
                                        <th class="text-white" >ICt Request Type</th>
            ...
            <form action="#">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="controls">
                            <label >Type of ICT Request Type</label>
