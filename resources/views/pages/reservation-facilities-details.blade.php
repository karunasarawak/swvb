                                                ...
                                                <div class="card-body card-dashboard">
                                                    <div class="table-responsive">
                                                        <table class="table table-borderless">
                                                            <thead >
                                                                <tr>
                                                                    <th class=" h7 swvb-blue m-0 font-weight-bold my-auto pb-2">Facilities Info<i class="bx bx-pencil"></i></th>
                                                                </tr>
                                                            </thead>
                                                            <tr>
                                                                <td>II Desposit</td>
                                                            ...
                                                            <thead >
                                                                <tr>
                                                                    <th class=" h7 swvb-blue m-0 font-weight-bold my-auto pb-2">II Exchange<i class="bx bx-pencil"></i></th>
                                                                </tr>
                                                            </thead>
                                                             <tr>
                                                                <td>Trading No</td>
