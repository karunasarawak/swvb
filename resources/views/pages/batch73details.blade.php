        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <a href="" class="btn btn-outline-white text-white round mr-1 mb-1" data-toggle="modal" data-target="#inlineForm">Split Week</a>
                            ...
                            <div class="card-body card-dashboard">
                                <div class="table-responsive">
                                    ...
                                    <table class="table tours-all">
                                        ...
                                        <tr>
                                                <th colspan="11"></th>
                                                <th class="text-white" colspan="3">Member</th>
                                                <th class="text-white" rowspan="2">Desired Travel Destination & Date</th>
                                                <th class="text-white" colspan="2">Charge To</th>
                                                <th class="text-white">ICT</th>
                                                <th class="text-white">Deposit</th>
                                                <th class="text-white" colspan="2">Internal Reference</th>
                                                <th class="text-white" colspan="3">RCI Guest</th>
                                    ...
                                    <table class="table tours-all">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>03:05 AM</td>
                                                <td>Charles Dean</td>
                                                <td><button class="border-0 bg-transparent" data-toggle="modal" data-target="#downloadprint"><i class="bx bx-dots-horizontal-rounded"></i></button></td>
                                                <td><button class="border-0 bg-transparent" data-toggle="modal" data-target="#downloadprint"><i class="bx bx-dots-horizontal-rounded"></i></button></td>
